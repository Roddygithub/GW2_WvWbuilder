...
export const PROFESSIONS_DATA: Record<string, ProfessionData> = {
  Guardian: {
    ...
    description:
      "A versatile profession with strong defensive and support capabilities.",
  },
  Warrior: {
    name: "Warrior",
    icon: "⚔️",
    ...
    description:
      "A strong melee fighter with powerful offensive and team support abilities.",
  },
  Engineer: {
    name: "Engineer",
    icon: "🔧",
    ...
    description:
      "A versatile profession with a wide range of gadgets and tools.",
  },
  Ranger: {
    name: "Ranger",
    icon: "🏹",
    ...
    description:
      "A nature-based profession that fights alongside pets and spirits.",
  },
  Thief: {
    name: "Thief",
    icon: "🗡️",
    ...
    description:
      "A highly mobile profession focused on stealth and burst damage.",
  },
  Elementalist: {
    name: "Elementalist",
    icon: "🔥",
