...
describe("ProfessionSelect", () => {
  ...
  it("opens the popover when clicking the button", async () => {
    ...
    expect(screen.getByPlaceholderText(/rechercher une profession/i)).toBeInTheDocument()
  ...
  it("filters professions based on search input", async () => {
    ...
    const searchInput = screen.getByPlaceholderText(/rechercher une profession/i)
  ...
  it("respects the maxSelections prop", async () => {
    ...
    const elementalistOption = screen.getByRole("option", { name: /elementalist/i })
