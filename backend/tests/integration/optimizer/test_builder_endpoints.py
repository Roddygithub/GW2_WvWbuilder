...
class TestBuilderOptimizeEndpoint:
    ...
    async def test_optimize_wvw_zerg(
        self, client: AsyncClient, normal_user_token_headers
    ):
    ...
    async def test_optimize_pve_fractale(
        self, client: AsyncClient, normal_user_token_headers
    ):
    ...
    async def test_optimize_with_fixed_professions(
        self, client: AsyncClient, normal_user_token_headers
    ):
    ...
    async def test_optimize_with_min_boon_uptime(
        self, client: AsyncClient, normal_user_token_headers
    ):
    ...
    async def test_optimize_invalid_game_type(
        self, client: AsyncClient, normal_user_token_headers
    ):
    ...
    async def test_optimize_invalid_squad_size(
        self, client: AsyncClient, normal_user_token_headers
    ):
    ...
    async def test_optimize_wvw_roaming(
        self, client: AsyncClient, normal_user_token_headers
    ):
    ...
    async def test_optimize_pve_openworld(
        self, client: AsyncClient, normal_user_token_headers
    ):
...
class TestBuilderModesEndpoint:
    ...
    async def test_modes_have_required_fields(
        self, client: AsyncClient, normal_user_token_headers
    ):
...
class TestBuilderProfessionsEndpoint:
    ...
    async def test_professions_have_required_fields(
        self, client: AsyncClient, normal_user_token_headers
    ):
    ...
    async def test_professions_list(
        self, client: AsyncClient, normal_user_token_headers
    ):
...
class TestBuilderRolesEndpoint:
    ...
    async def test_roles_have_required_fields(
        self, client: AsyncClient, normal_user_token_headers
    ):
...
class TestBuilderPerformance:
    ...
    async def test_optimize_completes_within_time_budget(
        self, client: AsyncClient, normal_user_token_headers
    ):
    ...
    async def test_optimize_large_squad(
        self, client: AsyncClient, normal_user_token_headers
    ):
...
class TestBuilderEdgeCases:
    ...
    async def test_optimize_minimum_squad(
        self, client: AsyncClient, normal_user_token_headers
    ):
    ...
    async def test_optimize_with_many_fixed_professions(
        self, client: AsyncClient, normal_user_token_headers
    ):
    ...
    async def test_optimize_all_game_modes(
        self, client: AsyncClient, normal_user_token_headers
    ):
        ...
        for game_type, game_mode, squad_size in game_modes:
            ...
            ), f"Failed for {game_type}/{game_mode}"
            data = response.json()
