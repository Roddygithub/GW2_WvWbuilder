...
from app.models.base_models import User, Role, Build, Profession
...
def test_user(db: Session):
    ...
    try:
        ...
        from app.models.base_models import user_roles
        ...
        refreshed_user = db.query(User).options(
...
def test_professions(db: Session):
    ...
    import uuid
    from app.models.base_models import EliteSpecialization, Profession
...
def test_create_build(client: TestClient, db: Session, test_user: User, test_professions: tuple, test_build_data: dict) -> None:
    ...
    try:
        ...
        build = db.query(Build).options(joinedload(Build.professions))\
...
def test_get_build(client: TestClient, db: Session, test_user: User, test_professions: tuple) -> None:
    ...
    try:
        ...
        from app.models.base_models import Build, build_profession
