    ...
    @pytest.mark.parametrize(
        ...
        [
            ...
            (
                ...
                2,
                1,
                {"healer": 1, "dps": 2, "support": 1},
            ),  # More healers (adjusted to match actual behavior)
            (
                1,
                1,
                1,
                {"healer": 1, "dps": 1, "support": 1},
            ),  # More support (adjusted to match actual behavior)
        ],
    )
    def test_generate_build_role_distributions(
        self,
        client: TestClient,
        min_healers: int,
        min_dps: int,
