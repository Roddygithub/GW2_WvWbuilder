...
@pytest.mark.asynbox async def test_delete_build(client: AsyncClient, test_build, test_user):
...
@pytest.mark.asynbox async def test_list_builds(client: AsyncClient, test_build, test_user):
...
@pytest.mark.asynbox async def test_unauthorized_access(client: AsyncClient, test_build):
