...
@pytest.mark.asyncio
async def test_get_profession(client: AsyncClient, test_profession):
...
@pytest.mark.asyncio
async def test_list_professions(client: AsyncClient, test_profession):
...
@pytest.mark.asyncio
async def test_add_elite_specialization(
    client: AsyncClient, test_profession, admin_token
):
    ...
    assert any(
        spec["name"] == "Test Elite Spec" for spec in data["elite_specializations"]
    )


@pytest.mark.asyncio
async def test_update_profession(client: AsyncClient, test_profession, admin_token):
    """Test updating a profession (admin only)."""
    # Update data
    update_data = {"description": "Updated description", "icon": "updated_icon.png"}
...
@pytest.mark.asyncio
async def test_delete_profession(client: AsyncClient, test_profession, admin_token):
...
@pytest.mark.asyncio
async def test_unauthorized_access(client: AsyncClient, test_profession, test_token):
