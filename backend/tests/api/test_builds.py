...
from tests.test_config import Headers, ExpectedErrors
...
class TestBuildsAPI:
    ...
    def test_read_build(self, client: TestClient, test_data: dict, auth_headers: dict):
        ...
        public_build = next(
            build for build in test_data["builds"].values() 
            if build.is_public
        )
    ...
    def test_read_private_build_unauthorized(self, client: TestClient, test_data: dict, auth_headers: dict):
    ...
    def test_create_build(self, client: TestClient, test_data: dict, auth_headers: dict):
    ...
    def test_update_build(self, client: TestClient, test_data: dict, auth_headers: dict):
    ...
    def test_update_other_users_build(self, client: TestClient, test_data: dict, auth_headers: dict):
    ...
    def test_delete_build(self, client: TestClient, test_data: dict, auth_headers: dict, db):
    ...
    def test_delete_other_users_build(self, client: TestClient, test_data: dict, auth_headers: dict):
    ...
    def test_search_builds(self, client: TestClient, test_data: dict, auth_headers: dict):
    ...
    def test_get_user_builds(self, client: TestClient, test_data: dict, auth_headers: dict):
    ...
    def test_get_other_user_builds(self, client: TestClient, test_data: dict, auth_headers: dict):
...
class TestBuildsAPIPermissions:
    ...
    def test_admin_access(self, client: TestClient, test_data: dict, auth_headers: dict):
    ...
    def test_admin_can_delete_any_build(self, client: TestClient, test_data: dict, auth_headers: dict, db):
