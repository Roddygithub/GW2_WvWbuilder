...
@pytest.mark.asynbox async def test_change_password(client: AsyncClient, test_user, test_token, db_session):
...
@pytest.mark.asynbox async def test_admin_get_users(client: AsyncClient, admin_user, admin_token):
...
@pytest.mark.asynbox async def test_admin_update_user(client: AsyncClient, test_user, admin_token):
