...
@pytest.mark.asynbox async def test_get_role(client: AsyncClient, test_role):
...
@pytest.mark.asynbox async def test_list_roles(client: AsyncClient, test_role):
...
@pytest.mark.asynbox async def test_add_user_to_role(client: AsyncClient, test_role, test_user, admin_token):
...
@pytest.mark.asynbox async def test_update_role(client: AsyncClient, test_role, admin_token):
...
@pytest.mark.asynbox async def test_remove_user_from_role(client: AsyncClient, test_role, test_user, admin_token):
...
@pytest.mark.asynbox async def test_delete_role(client: AsyncClient, test_role, admin_token):
...
@pytest.mark.asynbox async def test_unauthorized_access(client: AsyncClient, test_role, test_token):
