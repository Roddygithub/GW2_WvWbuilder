...
class TestTagsAPI:
    ...
    async def test_create_tag(self, async_client: AsyncClient, auth_headers):
        ...
        response = await async_client.post(
            f"{settings.API_V1_STR}/tags/", json=tag_data, headers=admin_headers
        )
    ...
    async def test_create_tag_unauthorized(
        ...
        response = await async_client.post(
            f"{settings.API_V1_STR}/tags/", json=tag_data, headers=user_headers
        )
    ...
    async def test_read_tags(
        self, async_client: AsyncClient, tag_factory, auth_headers
    ):
        ...
        response = await async_client.get(
            f"{settings.API_V1_STR}/tags/", headers=headers
        )
    ...
    async def test_read_nonexistent_tag(self, async_client: AsyncClient, auth_headers):
        ...
        response = await async_client.get(
            f"{settings.API_V1_STR}/tags/999999", headers=headers
        )
    ...
    async def test_delete_tag(
        ...
        response = await async_client.delete(
            f"{settings.API_V1_STR}/tags/{tag.id}", headers=admin_headers
        )
