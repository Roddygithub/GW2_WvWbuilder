...
def test_reset_to_defaults(updater):
    ...
    analyses = [
        {"spec": "Firebrand", "change_type": "nerf", "weight_delta": -0.15, "reasoning": "Test"},
        {"spec": "Scrapper", "change_type": "buff", "weight_delta": 0.10, "reasoning": "Test"},
    ]
    updater.apply_weight_adjustments(analyses)
...
def test_persistence(temp_data_dir):
    ...
    analyses = [
        {"spec": "Reaper", "change_type": "rework", "weight_delta": -0.15, "reasoning": "Test"},
    ]
...
def test_history_limit(updater):
    ...
    specs = ["firebrand", "scrapper", "herald", "tempest", "scourge", 
             "mechanist", "reaper", "weaver", "holosmith", "berserker"]
    
    for i, spec in enumerate(specs):
        analyses = [
            {"spec": spec, "change_type": "nerf", "weight_delta": -0.05, "reasoning": f"Test {i}"},
        ]
        updater.apply_weight_adjustments(analyses)
