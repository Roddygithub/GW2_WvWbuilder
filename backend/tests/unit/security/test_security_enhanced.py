...
class TestSecurityEnhanced:
    ...
    @pytest.mark.parametrize("password,expected_length,skip_verification", [
        (" ", 60, False),  # Whitespace
    ...
    @pytest.mark.parametrize("subject,expires_delta,expected_exp_seconds", [
        ...
        ("admin", None, settings.ACCESS_TOKEN_EXPIRE_MINUTES * 60),  # Default expiration
    ])
    ...
    @pytest.mark.parametrize("is_active,is_superuser,expected_error", [
