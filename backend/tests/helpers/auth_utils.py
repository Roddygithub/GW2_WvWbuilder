...
def get_superuser_auth_headers(
...
async def create_test_user(
    ...
    **kwargs
    ...
    """
    from app.tests.helpers.test_data import random_username, random_email, random_password
...
def assert_token_payload(
    ...
    if expected_sub is not None:
        assert str(payload["sub"]) == str(expected_sub), \
...
def assert_user_data(
    ...
    for key, expected_value in expected_data.items():
        ...
        assert user_data[key] == expected_value, \
