...
class TestRolesAPI:
    ...
    async def test_create_role(self, async_client: AsyncClient, auth_headers):
        ...
        response = await async_client.post(
            f"{settings.API_V1_STR}/roles/", json=TEST_ROLE_DATA, headers=admin_headers
        )
    ...
    async def test_create_role_duplicate_name(
        self, async_client: AsyncClient, role_factory, auth_headers
    ):
        ...
        response = await async_client.post(
            f"{settings.API_V1_STR}/roles/", json=role_data, headers=admin_headers
        )
    ...
    async def test_get_role(
        ...
        response = await async_client.get(
            f"{settings.API_V1_STR}/roles/{role.id}", headers=headers
        )
    ...
    async def test_get_nonexistent_role(self, async_client: AsyncClient, auth_headers):
        ...
        headers = await auth_headers()
        response = await async_client.get(
            f"{settings.API_V1_STR}/roles/999999", headers=headers
        )
    ...
    async def test_list_roles(
        ...
        response = await async_client.get(
            f"{settings.API_V1_STR}/roles/", headers=headers
        )
    ...
    async def test_delete_role(
        ...
        response = await async_client.delete(
            f"{settings.API_V1_STR}/roles/{role.id}", headers=admin_headers
        )
    ...
    async def test_delete_nonexistent_role(
        ...
        response = await async_client.delete(
            f"{settings.API_V1_STR}/roles/99999", headers=admin_headers
        )
        assert response.status_code == status.HTTP_404_NOT_FOUND

    async def test_unauthorized_create_role(
        self, async_client: AsyncClient, auth_headers
    ):
        ...
        response = await async_client.post(
            f"{settings.API_V1_STR}/roles/", json=role_data, headers=user_headers
        )
...
class TestUserRolesAPI:
    ...
    async def test_add_role_to_user(
        self, async_client: AsyncClient, user_factory, role_factory, auth_headers
    ):
        ...
        response = await async_client.post(
            f"{settings.API_V1_STR}/users/{user.id}/roles/{role.id}",
            headers=admin_headers,
        )

        assert response.status_code == status.HTTP_200_OK
        # Re-fetch user to check roles
        updated_user_response = await async_client.get(
            f"{settings.API_V1_STR}/users/{user.id}", headers=admin_headers
        )
