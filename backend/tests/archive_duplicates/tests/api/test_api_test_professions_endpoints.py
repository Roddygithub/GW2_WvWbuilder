...
class TestProfessionsAPI:
    ...
    async def test_create_profession(self, async_client: AsyncClient, auth_headers):
        ...
        response = await async_client.post(
            f"{settings.API_V1_STR}/professions/",
    ...
    async def test_get_profession(
        self, async_client: AsyncClient, profession_factory, auth_headers
    ):
        ...
        response = await async_client.get(
            f"{settings.API_V1_STR}/professions/{profession.id}", headers=headers
        )
    ...
    async def test_get_nonexistent_profession(
        self, async_client: AsyncClient, auth_headers
    ):
        """Test retrieving a non-existent profession by ID."""
        headers = await auth_headers()
        response = await async_client.get(
            f"{settings.API_V1_STR}/professions/999999", headers=headers
        )
    ...
    async def test_list_professions(
        ...
        response = await async_client.get(
            f"{settings.API_V1_STR}/professions/", headers=headers
        )
    ...
    async def test_update_profession(
        ...
        update_data = {
            ...
            "icon_url": "http://new.icon/url.png",
        }

        response = await async_client.put(
            f"{settings.API_V1_STR}/professions/{profession.id}",
            json=update_data,
            headers=admin_headers,
        )
    ...
    async def test_update_nonexistent_profession(
        self, async_client: AsyncClient, auth_headers
    ):
        ...
        response = await async_client.put(
            f"{settings.API_V1_STR}/professions/999999",
            json=update_data,
            headers=admin_headers,
        )
    ...
    async def test_delete_nonexistent_profession(
        self, async_client: AsyncClient, auth_headers
    ):
        ...
        response = await async_client.delete(
            f"{settings.API_V1_STR}/professions/999999", headers=admin_headers
        )
    ...
    async def test_unauthorized_create_profession(
        self, async_client: AsyncClient, auth_headers
    ):
