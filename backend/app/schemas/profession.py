...
class ProfessionBase(BaseModel):
    ...
    description: Optional[str] = Field(
        ...
        examples=["Une profession qui utilise des pouvoirs magiques pour protéger ses alliés et combattre ses ennemis."],
        json_schema_extra={"x-example": "Une profession qui utilise des pouvoirs magiques pour protéger ses alliés et combattre ses ennemis."}
    )
...
class EliteSpecializationBase(BaseModel):
    ...
    description: str = Field(
        ...
        json_schema_extra={"x-example": "Spécialisation d'élite maniant le grimoire et axée sur le support et les dégâts de condition."}
    )
